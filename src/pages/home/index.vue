<template>
	<view class="content">
		...
		<view class="notice-wrapper">
			<uni-notice-bar class="notice" scrollable="true" single="true"
				:text="notice" background-color="#9f8080" showIcon="true"
				:speed="30" color="#fff">
			</uni-notice-bar>
		</view>
		<view @click="navigateToMine">
			<!-- 用户区域 -->
			<user :nickname="nickName" :isAuthed="isAuthed"
				:avatarUrl="avatarUrl" :remainingDays="daysRemaining"
		...
		<view class="section">
			...
			<view class="section-right">
				<view class="section-random" @click="naviToRandromPage">
					...
					<image src="../../static/section/begin_random.png"
						mode="aspectFill" />
				</view>
				<view class="section-wrong" @click="naviToWrongPage">
					<image src="../../static/section/begin_wrong.png"
						mode="aspectFill" />
		...
		<view class="section-rank" @click="naviToRankPage">
			<image src="../../static/section/begin_rank.png"
				mode="aspectFill" />
