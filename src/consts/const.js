...
const MINE_LISTS_ADMIN = [{
	id: 1,
	class: 'note',
	content: '我的笔记',
	color: '#6A3F3F',
	navToFunc: 'navToMyNote'
},
{
	id: 2,
	class: 'collection',
...
const ADMIN_LISTS = [{
	id: 1,
	class: 'set-notice-bar',
	content: '设置公告栏',
	color: '#6A3F3F',
	navToFunc: 'navToSetNoticeBar'
},
{
	id: 2,
	class: 'add-question',
